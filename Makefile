...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile kkServer.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -ltufao1 -lhiredis -lQt5Sql -L/usr/lib/x86_64-linux-gnu -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: kkServer.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/kkServer1.0.0 || mkdir -p .tmp/kkServer1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/kkServer1.0.0/ && $(COPY_FILE) --parents server.h def.h unit.h .tmp/kkServer1.0.0/ && $(COPY_FILE) --parents main.cpp server.cpp .tmp/kkServer1.0.0/ && (cd `dirname .tmp/kkServer1.0.0` && $(TAR) kkServer1.0.0.tar kkServer1.0.0 && $(COMPRESS) kkServer1.0.0.tar) && $(MOVE) `dirname .tmp/kkServer1.0.0`/kkServer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/kkServer1.0.0
...
moc_server.cpp: /usr/include/qt5/QtSql/QSqlDatabase \
